...
const KNOWLEDGE_BASE = {
  ...
  experience: "Prajwalkumar has completed two internships:\n1. Frontend AI Engineering Intern at FlyRank AI (2026 – Present), building responsive UIs and integrating LLM features.\n2. Full Stack Development Intern at Thiranex (June – July 2026), gaining hands-on experience designing, developing, and deploying responsive web apps, RESTful APIs, and database integrations.",
  projects: "He has built the following projects:\n1. ASTRA AI: An AI-powered intelligent assistant utilizing LLMs and RAG to deliver context-aware conversational responses over custom knowledge bases, designed with React and FastAPI.\n2. Community Hero: A volunteer and community service management platform connecting volunteers with service initiatives using React, Firebase Auth, Firestore, and Firebase Hosting.",
  skills: "His technical skills include:\n- Languages: Python, JavaScript/TypeScript, SQL (basics)\n- AI / ML: Pandas, NumPy, RAG Pipelines, LLMs (basics)\n- Full Stack: React.js, Node.js, FastAPI, REST APIs, HTML/CSS\n- Databases: MongoDB, MySQL\n- DevOps & Cloud: Docker, Git/GitHub, GitHub Actions (CI/CD), Vercel, Firebase\n- Core CS: Data Structures & Algorithms, OOP, DBMS, Operating Systems, Computer Networks, System Design Basics\n- Other: Power BI, Excel, Agile/Scrum, MLflow",
  education: "He is pursuing a B.E. in Computer Science & Engineering at Rajarajeswari College of Engineering, VTU (2023 – 2027) with a CGPA of 8.0/10. Relevant coursework: Data Structures & Algorithms, DBMS, Operating Systems, Computer Networks, and Machine Learning.",
  contact: "You can contact him via:\n- Email: madiwalprajwalkumar@gmail.com\n- Phone: +91-7676222500\n- LinkedIn: www.linkedin.com/in/prajwalkumar19/\n- GitHub: github.com/Prajwalkumar-1906",
  certifications: "His certifications include:\n- Getting Started with AI on Jetson Nano (NVIDIA)\n- Oracle Certified Foundations Associate (Oracle Cloud Infrastructure)\n- Introducing the High Tech Industry (SAP Certified)\n- Intra-College Webathon 2026 — Finalist",
  achievements: "Key achievements and involvement:\n- Community Manager at Dream Den Club\n- Active technical content creator on LinkedIn with 5k+ followers\n- Volunteer at AIXchange Meetup Group\n- Speaker on Agentic AI at SAP Inside Track Bengaluru (Devanahalli Campus)\n- Core member at One World One Family Mission & Annapurna Trust",
